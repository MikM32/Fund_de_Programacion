...
void fleer_trbj(FILE* fp, Trabajador* trbj)
{
    ...
    else if(strstr(buffer, "Dise�o")!=NULL)
    {
        trbj->dep = 3;
    }
    ...
    else if(strstr(buffer, "Dise�ador")!=NULL)
    {
        trbj->cargo = 4;
    }
...
void leer_trbj(Trabajador* trbj)
{
    ...
    fflush(stdin);
    printf("Ingrese el departamento(1:RHH, 2:Consultorio, 3:Dise�o, 4:Produccion, 5:Calidad, 6:Distribucion): ");
    scanf("%i",&(trbj->dep));
    fflush(stdin);
    printf("Ingrese el cargo(1:Gerente, 2:Supervisor, 3:Analista, 4:Dise�ador, 5:Desarrollador, 6:Auditor): ");
    scanf("%i",&(trbj->cargo));
    fflush(stdin);
...
void consultar()
{
    ...
    case 'c':
        ...
        printf("(1:Gerente, 2:Supervisor, 3:Analista, 4:Dise�ador, 5:Desarrollador, 6:Auditor): ");
